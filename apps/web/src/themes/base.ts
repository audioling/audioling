...
export const baseTheme: AppThemeConfiguration['theme'] = {
    ...
    'scroll-bar-thumb-active-background-color': 'rgba(160, 160, 160, 1)',
    'scroll-bar-thumb-background-color': 'rgba(160, 160, 160, 0.5)',
    'scroll-bar-thumb-border-radius': radius.lg,
    'scroll-bar-thumb-hover-background-color': 'rgba(160, 160, 160, 0.8)',
