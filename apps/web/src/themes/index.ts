...
export type AppThemeConfiguration = {
    ...
    theme: {
        ...
        'layout-nav-bar-left-background-color': CSSProperties['backgroundColor'];
        'layout-nav-bar-left-border-bottom': CSSProperties['border'];
        'layout-nav-bar-left-border-left': CSSProperties['border'];
        'layout-nav-bar-left-border-right': CSSProperties['border'];
        'layout-nav-bar-left-border-top': CSSProperties['border'];
        'layout-nav-bar-left-font-color': CSSProperties['color'];
        'layout-nav-bar-left-height': CSSProperties['height'];
        'layout-nav-bar-left-item-hover-background-color': CSSProperties['backgroundColor'];
        'layout-nav-bar-left-item-hover-font-color': CSSProperties['color'];
