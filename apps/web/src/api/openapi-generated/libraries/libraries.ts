...
export const getPostApiLibrariesMutationOptions = <
    TData = Awaited<ReturnType<typeof postApiLibraries>>,
    TError = ErrorType<
        | PostApiLibraries400
        | PostApiLibraries401
        | PostApiLibraries403
...
>(options?: {
    ...
    >;
    request?: SecondParameter<typeof apiInstance>;
}): UseMutationResult<TData, TError, { data: BodyType<PostApiLibrariesBody> }, TContext> => {
...
export const getPutApiLibrariesIdMutationOptions = <
    TData = Awaited<ReturnType<typeof putApiLibrariesId>>,
    TError = ErrorType<
        | PutApiLibrariesId400
        | PutApiLibrariesId401
        | PutApiLibrariesId403
...
export const getDeleteApiLibrariesIdMutationOptions = <
    TData = Awaited<ReturnType<typeof deleteApiLibrariesId>>,
    TError = ErrorType<
        | DeleteApiLibrariesId401
        | DeleteApiLibrariesId403
        | DeleteApiLibrariesId404
...
export const getPostApiLibrariesIdAuthMutationOptions = <
    TData = Awaited<ReturnType<typeof postApiLibrariesIdAuth>>,
    TError = ErrorType<
        | PostApiLibrariesIdAuth400
        | PostApiLibrariesIdAuth401
        | PostApiLibrariesIdAuth403
...
>(options?: {
    ...
    const mutationKey = ['postApiLibrariesIdAuth'];
    const { mutation: mutationOptions, request: requestOptions } = options
        ? options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey
            ? options
            : { ...options, mutation: { ...options.mutation, mutationKey } }
